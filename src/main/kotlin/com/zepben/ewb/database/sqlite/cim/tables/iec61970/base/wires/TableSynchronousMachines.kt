...
class TableSynchronousMachines : com.zepben.ewb.database.sqlite.cim.tables.iec61970.base.wires.TableRotatingMachines() {

    val BASE_Q: Column = Column(++columnIndex, "base_q", Column.Type.DOUBLE, NULL)
    val CONDENSER_P: Column = Column(++columnIndex, "condenser_p", Column.Type.INTEGER, NULL)
    val EARTHING: Column = Column(++columnIndex, "earthing", Column.Type.BOOLEAN, NULL)
    val EARTHING_STAR_POINT_R: Column = Column(++columnIndex, "earthing_star_point_r", Column.Type.DOUBLE, NULL)
    val EARTHING_STAR_POINT_X: Column = Column(++columnIndex, "earthing_star_point_x", Column.Type.DOUBLE, NULL)
    val IKK: Column = Column(++columnIndex, "ikk", Column.Type.DOUBLE, NULL)
    val MAX_Q: Column = Column(++columnIndex, "max_q", Column.Type.DOUBLE, NULL)
    val MAX_U: Column = Column(++columnIndex, "max_u", Column.Type.INTEGER, NULL)
    val MIN_Q: Column = Column(++columnIndex, "min_q", Column.Type.DOUBLE, NULL)
    val MIN_U: Column = Column(++columnIndex, "min_u", Column.Type.INTEGER, NULL)
    val MU: Column = Column(++columnIndex, "mu", Column.Type.DOUBLE, NULL)
    val R: Column = Column(++columnIndex, "r", Column.Type.DOUBLE, NULL)
    val R0: Column = Column(++columnIndex, "r0", Column.Type.DOUBLE, NULL)
    val R2: Column = Column(++columnIndex, "r2", Column.Type.DOUBLE, NULL)
    val SAT_DIRECT_SUBTRANS_X: Column = Column(++columnIndex, "sat_direct_subtrans_x", Column.Type.DOUBLE, NULL)
    val SAT_DIRECT_SYNC_X: Column = Column(++columnIndex, "sat_direct_sync_x", Column.Type.DOUBLE, NULL)
    val SAT_DIRECT_TRANS_X: Column = Column(++columnIndex, "sat_direct_trans_x", Column.Type.DOUBLE, NULL)
    val X0: Column = Column(++columnIndex, "x0", Column.Type.DOUBLE, NULL)
    val X2: Column = Column(++columnIndex, "x2", Column.Type.DOUBLE, NULL)
    val TYPE: Column = Column(++columnIndex, "type", Column.Type.STRING, NOT_NULL)
    val OPERATING_MODE: Column = Column(++columnIndex, "operating_mode", Column.Type.STRING, NOT_NULL)
