 ...
 * @property variantService A [NetworkModelProjectService].
 */
open class Services(
    ...
    val variantService: NetworkModelProjectService = NetworkModelProjectService(),
) {
     ...
     */
    operator fun component4(): NetworkModelProjectService = variantService
