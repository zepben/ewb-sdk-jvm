...
internal class TracingTest {
    ...
    internal fun coverage() {
        ...
        validate({ Tracing.normalDownstreamEquipmentTrace() }, BasicTraversal::class.java)
        validate({ Tracing.currentDownstreamEquipmentTrace() }, BasicTraversal::class.java)
        validate({ Tracing.normalUpstreamEquipmentTrace() }, BasicTraversal::class.java)
        validate({ Tracing.currentUpstreamEquipmentTrace() }, BasicTraversal::class.java)
