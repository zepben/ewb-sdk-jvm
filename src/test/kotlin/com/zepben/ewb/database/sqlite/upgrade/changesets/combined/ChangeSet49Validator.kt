...
object ChangeSet49Validator : ChangeSetValidator(DatabaseType.NETWORK_MODEL, 49) {
    ...
    override fun validateChanges(statement: Statement) {
        ...
        validateRows(
            statement, "SELECT * FROM relay_info",
            { rs ->
        ...
        validateRows(
            statement, "SELECT * FROM protection_relay_schemes",
            { rs ->
        ...
        validateRows(
            statement, "SELECT * FROM protection_relay_systems",
            { rs ->
        ...
        validateRows(
            statement, "SELECT * FROM ground_disconnectors",
            { rs ->
        ...
        validateRows(
            statement, "SELECT * FROM series_compensators",
            { rs ->
        ...
        validateRows(
            statement, "SELECT * FROM protection_relay_function_thresholds",
            { rs ->
        ...
        validateRows(
            statement, "SELECT * FROM protection_relay_function_time_limits",
            { rs ->
                assertThat(rs.getString("protection_relay_function_mrid"), equalTo("id7"))
                assertThat(rs.getInt("sequence_number"), equalTo(1))
        ...
        validateRows(
            statement, "SELECT * FROM protection_relay_functions_protected_switches",
            { rs ->
                assertThat(rs.getString("protection_relay_function_mrid"), equalTo("id7"))
        ...
        validateRows(
            statement, "SELECT * FROM protection_relay_functions_sensors",
            { rs ->
                assertThat(rs.getString("protection_relay_function_mrid"), equalTo("id7"))
        ...
        validateRows(
            statement, "SELECT * FROM protection_relay_schemes_protection_relay_functions",
            { rs ->
