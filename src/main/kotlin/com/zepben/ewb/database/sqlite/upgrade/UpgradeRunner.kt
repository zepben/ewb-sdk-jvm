...
package com.zepben.ewb.database.sqlite.upgrade
...
import com.zepben.ewb.database.sqlite.upgrade.changesets.*
 ...
 *
 * @param getConnection A factory function for connecting to the database given a connection string.
 * @param copyFile A function used to make a copy of a file.
 * @param preSplitChangeSets The change sets that can be run on the singular network database before it was split.
 * @param postSplitChangeSets The change sets that can be run on the split databases.
 * @param tableVersion The table containing the version information on what to expect in this database.
 */
class UpgradeRunner @JvmOverloads constructor(
    ...
    /**
     * Run the commands for a change set.
     *
     * @param changeSet The [ChangeSet] to apply.
     * @param statement The [Statement] used to execute the [changeSet] commands.
     * @param versionUpdateStatement A [PreparedStatement] that can be used to update the version number after the [changeSet] has been applied.
     * @param type The type of database being upgraded.
     */
