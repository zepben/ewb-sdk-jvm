...
internal class ConnectTest {
    ...
    internal fun connectWithSecretAndAuthConfJvmOverloadsCoverage() {
        ...
        assertThat(
            Connect.connectWithSecret("clientId", "clientSecret", "audience", "issuerDomain", authMethod = AuthMethod.ENTRAID),
            equalTo(grpcChannelWithAuth)
        )
        assertThat(
            Connect.connectWithSecret("clientId", "clientSecret", "audience", "issuerDomain", "localhost", authMethod = AuthMethod.ENTRAID),
            equalTo(grpcChannelWithAuth)
        )
        assertThat(
    ...
    internal fun connectWithPasswordAndAuthConfJvmOverloadsCoverage() {
        ...
        assertThat(
            Connect.connectWithPassword("clientId", "username", "password", "audience", "issuer", authMethod = AuthMethod.ENTRAID),
            equalTo(grpcChannelWithAuth)
        )
        assertThat(
            Connect.connectWithPassword("clientId", "username", "password", "audience", "issuer", "localhost", authMethod = AuthMethod.ENTRAID),
            equalTo(grpcChannelWithAuth)
        )
        assertThat(
