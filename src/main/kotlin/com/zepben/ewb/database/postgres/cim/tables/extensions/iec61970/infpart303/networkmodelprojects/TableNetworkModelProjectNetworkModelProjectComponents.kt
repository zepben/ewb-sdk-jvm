...
class TableNetworkModelProjectNetworkModelProjectComponents : PostgresTable() {

    val NETWORK_MODEL_PROJECT_MRID: Column = Column(++columnIndex, "network_model_project_mrid", Column.Type.STRING, Nullable.NOT_NULL)
    val NETWORK_MODEL_PROJECT_COMPONENT_MRID: Column = Column(++columnIndex, "network_model_project_component_mrid", Column.Type.STRING, Nullable.NOT_NULL)
