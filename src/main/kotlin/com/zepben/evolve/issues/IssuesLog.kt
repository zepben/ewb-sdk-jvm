...
package com.zepben.evolve.issues

import org.slf4j.Logger

class IssuesLog(val detailedLogging: Boolean = false, val logger: Logger, val cimLogger: Logger? = null) {
    private val issueTrackers: MutableMap<String, MutableList<IssueTrackerGroup>> = linkedMapOf()

    fun add(category: String, issueTrackerGroup: IssueTrackerGroup) {
