...
import com.zepben.ewb.services.network.tracing.feeder.DirectionValidator.validateDirection
...
internal class SetDirectionTest {
    ...
    internal fun setsDirectionOnAclsWithCutsAndClampsFromAclsEndTerminal() {
        val n = CutsAndClampsNetwork.multiCutAndClampNetwork()
            .addFeeder("b0", 2)
            .network

        n.get<Cut>("c1-cut1")?.setNormallyOpen(false)
        n.get<Cut>("c1-cut2")?.setNormallyOpen(true)

        doSetDirectionTrace(n.getT("b0", 2))

        n.getT("b0", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-clamp1", 1).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c3", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c3", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c4", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c4", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-cut1", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-cut1", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c5", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c5", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-clamp2", 1).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-clamp3", 1).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        ...
        n.getT("c1-cut2", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-cut2", 2).validateDirection(NONE, NetworkStateOperators.NORMAL)
    }
    ...
    internal fun setsDirectionOnAclsWithCutsAndClampsFedFromClamp() {
        ...
        n.getT("c1-clamp2", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-clamp3", 1).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c7", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c7", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c8", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        ...
        n.getT("c5", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c5", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-cut1", 2).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-cut1", 1).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c4", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c4", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-clamp1", 1).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c3", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
    ...
    internal fun setsDirectionOnAclsWithCutsAndClampsFedFromBothAclsEnds() {
        ...
        n.get<Cut>("c1-cut1")?.setNormallyOpen(false)
        n.get<Cut>("c1-cut2")?.setNormallyOpen(false)
        ...
        n.getT("c4", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c4", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-cut1", 2).validateDirection(BOTH, NetworkStateOperators.NORMAL)
        n.getT("c1-cut1", 1).validateDirection(BOTH, NetworkStateOperators.NORMAL)
        n.getT("c5", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c5", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-clamp2", 1).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c6", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        ...
        n.getT("c8", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c8", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-cut2", 1).validateDirection(BOTH, NetworkStateOperators.NORMAL)
        n.getT("c1-cut2", 2).validateDirection(BOTH, NetworkStateOperators.NORMAL)
        ...
        n.getT("c1-clamp4", 1).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
    ...
    internal fun setsDirectionOnAclsWithCutsAndClampsFedFromAclsEndAndClamp() {
        ...
        n.getT("c5", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c5", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-clamp2", 1).validateDirection(BOTH, NetworkStateOperators.NORMAL)
    ...
    internal fun setsDirectionOnAclsWithCutsAndClampsFedFromAclsClampAndCut() {
        ...
        n.getT("b0", 1).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1", 1).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c1-clamp1", 1).validateDirection(BOTH, NetworkStateOperators.NORMAL)
        n.getT("c3", 1).validateDirection(BOTH, NetworkStateOperators.NORMAL)
        n.getT("c3", 2).validateDirection(NONE, NetworkStateOperators.NORMAL)
        n.getT("c4", 1).validateDirection(UPSTREAM, NetworkStateOperators.NORMAL)
        n.getT("c4", 2).validateDirection(DOWNSTREAM, NetworkStateOperators.NORMAL)
