...
object Connect {
     ...
     * @param verifyCertificates Whether to verify the certificate chain of the server, defaults to true
    ...
    fun connectWithAccessToken(
        ...
        return GrpcChannelBuilder().forAddress(host, rpcPort).makeSecure(rootCertificates = caFilename, verifyCertificates).withAccessToken(personalAccessToken).build(buildArgs)
    }
