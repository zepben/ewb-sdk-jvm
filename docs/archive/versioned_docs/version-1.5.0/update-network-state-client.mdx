...
```java
import com.zepben.ewb.streaming.data.SwitchStateEvent;
import com.zepben.ewb.streaming.mutations.UpdateNetworkStateClient;
...
```java
import com.zepben.ewb.streaming.data.AddCutEvent;
import com.zepben.ewb.streaming.mutations.UpdateNetworkStateClient;
...
```java
import com.zepben.ewb.streaming.data.RemoveCutEvent;
import com.zepben.ewb.streaming.mutations.UpdateNetworkStateClient;
...
```java
import com.zepben.ewb.streaming.data.AddJumperEvent;
import com.zepben.ewb.streaming.data.JumperConnection;
import com.zepben.ewb.streaming.mutations.UpdateNetworkStateClient;
...
```java
import com.zepben.ewb.streaming.data.RemoveJumperEvent;
import com.zepben.ewb.streaming.mutations.UpdateNetworkStateClient;
...
You can check the type of response or failure by check against the types from `com.zepben.ewb.streaming.data.*`
<Tabs
    groupId="code-example"
    defaultValue="java"
    values={[
...
import com.zepben.ewb.streaming.data.StateEventUnknownMrid;
