...
data class ContactDetails @JvmOverloads constructor(
    ...
    @ZBEX private var _phoneNumbers: MutableList<TelephoneNumber>? = null,
    @ZBEX var contactAddress: StreetAddress? = null,
    @ZBEX private var _electronicAddresses: MutableList<ElectronicAddress>? = null,
    @ZBEX var contactType: String? = null,
    @ZBEX var firstName: String? = null,
    @ZBEX var lastName: String? = null,
    @ZBEX var preferredContactMethod: ContactMethodType = ContactMethodType.UNKNOWN,
    @ZBEX var isPrimary: Boolean? = null,
    @ZBEX var businessName: String? = null,
) {
