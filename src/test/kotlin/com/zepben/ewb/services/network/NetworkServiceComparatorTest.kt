...
internal class NetworkServiceComparatorTest : BaseServiceComparatorTest() {
    ...
    @Test
    internal fun compareControl() {
        compareIoPoint { Control(it) }
        comparatorValidator.validateProperty(Control::powerSystemResourceMRID, { Control(it) }, { "psr1" }, { "psr2" })
        comparatorValidator.validateProperty(Control::remoteControl, { Control(it) }, { RemoteControl("rc1") }, { RemoteControl("rc2") })
    }
    ...
    private fun compareIoPoint(createIoPoint: (String) -> IoPoint) {
        compareIdentifiedObject { createIoPoint(it) }
    }
    ...
    private fun compareRegulatingControl(createRegulatingControl: (String) -> RegulatingControl) {
        ...
        comparatorValidator.validateProperty(
            ...
            { RegulatingControlModeKind.UNKNOWN }
        )
