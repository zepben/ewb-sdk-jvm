...
CREATE TABLE power_transformers (mrid TEXT NOT NULL, name TEXT NOT NULL, description TEXT NOT NULL, num_diagram_objects INTEGER NOT NULL, location_mrid TEXT NULL, num_controls INTEGER NOT NULL, normally_in_service BOOLEAN, in_service BOOLEAN, base_voltage_mrid TEXT NULL, vector_group TEXT NOT NULL, transformer_utilisation NUMBER NULL, construction_kind TEXT NOT NULL, function TEXT NOT NULL, power_transformer_info_mrid TEXT NULL);
...
CREATE TABLE usage_points (mrid TEXT NOT NULL, name TEXT NOT NULL, description TEXT NOT NULL, num_diagram_objects INTEGER NOT NULL, location_mrid TEXT NULL, is_virtual BOOLEAN, connection_category TEXT NULL);
