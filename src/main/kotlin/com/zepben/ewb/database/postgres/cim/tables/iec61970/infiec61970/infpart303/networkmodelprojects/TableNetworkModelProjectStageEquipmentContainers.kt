...
class TableNetworkModelProjectStageEquipmentContainers : PostgresTable() {

    val NETWORK_MODEL_PROJECT_MRID: Column = Column(++columnIndex, "network_model_project_mrid", Column.Type.STRING, Nullable.NOT_NULL)
    val EQUIPMENT_CONTAINER_MRID: Column = Column(++columnIndex, "equipment_container_mrid", Column.Type.STRING, Nullable.NOT_NULL)
