 ...
 *   remove the split database logic - Check [com.zepben.ewb.database.sqlite.upgrade.UpgradeRunner] to see if this is still required.
 *
 ...
 * @param setFeederDirection The [SetDirection] trace used to apply run-time allocations to the [NetworkService] being read.
 * @param setPhases The [SetPhases] trace used to apply run-time allocations to the [NetworkService] being read.
 * @param phaseInferrer The [PhaseInferrer] trace used to apply run-time allocations to the [NetworkService] being read.
 * @param assignToFeeders The [AssignToFeeders] trace used to apply run-time allocations to the [NetworkService] being read.
 * @param assignToLvFeeders The [AssignToLvFeeders] trace used to apply run-time allocations to the [NetworkService] being read.
 */
class NetworkDatabaseReader internal constructor(
     ...
     * @param connection The connection to the database.
     * @param databaseDescription The description of the database for logging (e.g. filename).
     * @param inferPhases Indicates if phases should be inferred on partially energised network. Defaults to true.
     */
    @JvmOverloads
    constructor(
        connection: Connection,
