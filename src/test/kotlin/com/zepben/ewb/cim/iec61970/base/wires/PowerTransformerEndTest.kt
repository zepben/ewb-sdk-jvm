...
internal class PowerTransformerEndTest {
    ...
    internal fun accessorCoverage() {
        ...
        assertThat(powerTransformerEnd.connectionKind, equalTo(WindingConnection.UNKNOWN))
        ...
        assertThat(pte.sRatings, contains(TransformerEndRatedS(TransformerCoolingType.UNKNOWN, 11000)))
    }
