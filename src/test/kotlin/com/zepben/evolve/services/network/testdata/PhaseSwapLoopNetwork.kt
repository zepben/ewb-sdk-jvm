...
object PhaseSwapLoopNetwork {
    ...
    fun create(): NetworkService = NetworkService().also { network ->
        ...
        Feeder("fdr").apply { normalHeadTerminal = j0.getTerminal(1)!! }.also { network.add(it) }

        // Connect up a network so we can check connectivity.
        network.connect(j0.getTerminal(1)!!, "cn_0")
        ...
        network.connect(j1.getTerminal(1)!!, "cn_2")
        network.connect(j1.getTerminal(2)!!, "cn_3")
