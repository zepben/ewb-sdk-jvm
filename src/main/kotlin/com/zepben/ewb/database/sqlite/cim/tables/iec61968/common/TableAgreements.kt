 ...
 *
 * @property VALIDITY_INTERVAL_END A column storing the date and time interval this agreement is valid (from going into effect to termination).
 * @property VALIDITY_INTERVAL_START A column storing the date and time interval this agreement is valid (from going into effect to termination).
 */
