...
internal abstract class BaseCollectionReader<T>(
     ...
     *
     * @param TTable The [com.zepben.ewb.database.sql.common.tables.SqlTable] to read the objects from.
     * @param data The data to pass to the [processRow] handler.
     ...
     * @param prepareSelectStatement A factory to prepare the select statement for the table.
     */
     ...
     *
     * @param selectStatement The prepared select statement used to read the database records.
     * @param processRows THe callback used to process the selected rows.
     * @return true if the table was successfully read, otherwise false.
     */
