...
import com.zepben.cimbend.network.tracing.FindWithUsagePoints.Result.Status.*
import com.zepben.cimbend.testdata.SingleTransformerNetwork
...
class FindWithUsagePointsTest {
    ...
    //
    private val network = TestNetworks.withUsagePointsNetwork()
