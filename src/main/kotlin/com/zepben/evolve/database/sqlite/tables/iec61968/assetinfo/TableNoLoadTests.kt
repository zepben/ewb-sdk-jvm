...
class TableNoLoadTests : TableTransformerTest() {
    ...
    val EXCITING_CURRENT = Column(++columnIndex, "exciting_current", "NUMBER", NOT_NULL)
    val EXCITING_CURRENT_ZERO = Column(++columnIndex, "exciting_current_zero", "NUMBER", NOT_NULL)
