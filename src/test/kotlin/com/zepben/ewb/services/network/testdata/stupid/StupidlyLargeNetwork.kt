...
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.baseVoltageOf
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createAcLineSegment
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createAccumulator
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createAnalog
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createDiagram
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createDiagramObject
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createDiscrete
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createEnergySource
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createFeeder
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createFeederStart
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createGeographicalRegion
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createJunction
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createOperationalRestriction
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createService
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createSite
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createSubGeographicalRegion
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createSubstation
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createSwitch
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.createTransformer
import com.zepben.ewb.services.network.testdata.stupid.StupidlyLargeNetworkUtils.Companion.locationOf
