...
import com.zepben.ewb.database.sql.cim.tables.associations.*
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61968.assetinfo.TableRecloseDelays
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61968.assetinfo.TableRelayInfo
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61968.common.TableContactDetails
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61968.common.TableContactDetailsElectronicAddresses
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61968.common.TableContactDetailsStreetAddresses
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61968.common.TableContactDetailsTelephoneNumbers
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61968.metering.TablePanDemandResponseFunctions
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61970.base.core.TableHvCustomers
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61970.base.core.TableLvSubstations
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61970.base.core.TableSites
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61970.base.feeder.TableLoops
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61970.base.feeder.TableLvFeeders
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61970.base.generation.production.TableEvChargingUnits
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61970.base.protection.*
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61970.base.wires.TableBatteryControls
import com.zepben.ewb.database.sql.cim.tables.extensions.iec61970.base.wires.TablePowerTransformerEndRatings
import com.zepben.ewb.database.sql.cim.tables.iec61968.assetinfo.*
import com.zepben.ewb.database.sql.cim.tables.iec61968.assets.*
import com.zepben.ewb.database.sql.cim.tables.iec61968.common.*
import com.zepben.ewb.database.sql.cim.tables.iec61968.infiec61968.infassetinfo.TableCurrentTransformerInfo
import com.zepben.ewb.database.sql.cim.tables.iec61968.infiec61968.infassetinfo.TablePotentialTransformerInfo
import com.zepben.ewb.database.sql.cim.tables.iec61968.infiec61968.infassets.TablePoles
import com.zepben.ewb.database.sql.cim.tables.iec61968.metering.*
import com.zepben.ewb.database.sql.cim.tables.iec61968.operations.TableOperationalRestrictions
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.auxiliaryequipment.*
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.core.*
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.equivalents.TableEquivalentBranches
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.equivalents.TableEquivalentEquipment
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.generation.production.TableBatteryUnits
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.generation.production.TablePhotoVoltaicUnits
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.generation.production.TablePowerElectronicsUnits
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.generation.production.TablePowerElectronicsWindUnits
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.meas.*
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.protection.TableCurrentRelays
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.scada.TableRemoteControls
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.scada.TableRemotePoints
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.scada.TableRemoteSources
import com.zepben.ewb.database.sql.cim.tables.iec61970.base.wires.*
import com.zepben.ewb.database.sql.cim.tables.iec61970.infiec61970.feeder.TableCircuits
...
class NetworkCimWriter(
    ...
    @Throws(SQLException::class)
    private fun writeContactDetails(table: TableContactDetails, insert: PreparedStatement, contactDetails: ContactDetails, description: String): Boolean {
        ...
        var status = writeContactDetailsStreetAddress(contactDetails, contactDetails.contactAddress)
        contactDetails.phoneNumbers.forEach { status = status and writeContactDetailsTelephoneNumber(contactDetails, it) }
        contactDetails.electronicAddresses.forEach { status = status and writeContactDetailsElectronicAddress(contactDetails, it) }

        return status and insert.tryExecuteSingleUpdate(description)
    }

    @Throws(SQLException::class)
    private fun writeContactDetailsElectronicAddress(contactDetails: ContactDetails, electronicAddress: ElectronicAddress): Boolean {
        ...
        insert.setString(table.CONTACT_DETAILS_ID.queryIndex, contactDetails.id)

        return writeElectronicAddress(table, insert, electronicAddress, "electronic address for contact ${contactDetails.id}")
    }

    @Throws(SQLException::class)
    private fun writeContactDetailsStreetAddress(contactDetails: ContactDetails, streetAddress: StreetAddress?): Boolean {
        streetAddress ?: return true
        ...
        return writeStreetAddress(table, insert, streetAddress, "street address for contact ${contactDetails.id}")
    }

    @Throws(SQLException::class)
    private fun writeContactDetailsTelephoneNumber(contactDetails: ContactDetails, phoneNumber: TelephoneNumber): Boolean {
        ...
        return writeTelephoneNumber(table, insert, phoneNumber, "phone number for contact ${contactDetails.id}")
    }
    ...
    fun write(directionalCurrentRelay: DirectionalCurrentRelay): Boolean {
        ...
        insert.setString(table.POLARIZING_QUANTITY_TYPE.queryIndex, directionalCurrentRelay.polarizingQuantityType.name)
        insert.setString(table.RELAY_ELEMENT_PHASE.queryIndex, directionalCurrentRelay.relayElementPhase.name)
    ...
    @Throws(SQLException::class)
    private fun writeTransformerTest(table: TableTransformerTests, insert: PreparedStatement, transformerTest: TransformerTest, description: String): Boolean {
    ...
    private fun writeElectronicAddress(
        ...
        insert.setNullableString(table.DESCRIPTION.queryIndex, electronicAddress.description)
    ...
    private fun insertStreetDetail(table: TableStreetAddresses, insert: PreparedStatement, streetDetail: StreetDetail?) {
        ...
        insert.setNullableString(table.BUILDING_NUMBER.queryIndex, streetDetail?.buildingNumber)
    }
    ...
    private fun writeTelephoneNumber(
        ...
        insert.setNullableString(table.COUNTRY_CODE.queryIndex, telephoneNumber.countryCode)
        insert.setNullableString(table.DIAL_OUT.queryIndex, telephoneNumber.dialOut)
        insert.setNullableString(table.EXTENSION.queryIndex, telephoneNumber.extension)
        insert.setNullableString(table.INTERNATIONAL_PREFIX.queryIndex, telephoneNumber.internationalPrefix)
        insert.setNullableString(table.LOCAL_NUMBER.queryIndex, telephoneNumber.localNumber)
        insert.setNullableBoolean(table.IS_PRIMARY.queryIndex, telephoneNumber.isPrimary)
        insert.setNullableString(table.DESCRIPTION.queryIndex, telephoneNumber.description)
    ...
    private fun insertTownDetail(table: TableTownDetails, insert: PreparedStatement, townDetail: TownDetail?) {
        ...
        insert.setNullableString(table.COUNTRY.queryIndex, townDetail?.country)
    }
    ...
    fun write(usagePoint: UsagePoint): Boolean {
        ...
        usagePoint.contacts.forEach { status = status and writeUsagePointContactDetails(usagePoint, it) }

        return status and writeIdentifiedObject(table, insert, usagePoint, "usage point")
    }

    @Throws(SQLException::class)
    private fun writeUsagePointContactDetails(usagePoint: UsagePoint, contactDetails: ContactDetails): Boolean {
        val table = databaseTables.getTable<TableUsagePointsContactDetails>()
        val insert = databaseTables.getInsert<TableUsagePointsContactDetails>()

        insert.setNullableString(table.USAGE_POINT_MRID.queryIndex, usagePoint.mRID)

        return writeContactDetails(
            table,
            insert,
            contactDetails,
