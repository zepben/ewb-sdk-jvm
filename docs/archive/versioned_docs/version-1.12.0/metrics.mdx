...
public class IngestionJobExample {
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        MetricsDatabaseWriter metricsDatabaseWriter = new MetricsDatabaseWriter(
            ...
            // Optional: Folder containing files for the model exported by the ingestion job. The network, customer, and diagram databases should be located here.
            //           This, along with any missing parent directories, will be created by the `write` method if it is missing.
