...
import com.zepben.ewb.database.sqlite.upgrade.changesets.NoChanges
import com.zepben.ewb.database.sqlite.upgrade.changesets.combined.*
import com.zepben.ewb.database.sqlite.upgrade.changesets.customer.*
import com.zepben.ewb.database.sqlite.upgrade.changesets.diagram.ChangeSet50DiagramValidator
import com.zepben.ewb.database.sqlite.upgrade.changesets.diagram.ChangeSet52DiagramValidator
import com.zepben.ewb.database.sqlite.upgrade.changesets.diagram.ChangeSet61DiagramValidator
import com.zepben.ewb.database.sqlite.upgrade.changesets.diagram.ChangeSet62DiagramValidator
import com.zepben.ewb.database.sqlite.upgrade.changesets.network.*
...
internal class ChangeSetTest {
    ...
    private val customerChangeSetValidators = listOf(
        ...
        NoChanges(DatabaseType.CUSTOMER, 65),
    ).associateBy { it.version }
    ...
    private val diagramChangeSetValidators = listOf(
        ...
        NoChanges(DatabaseType.DIAGRAM, 65),
    ).associateBy { it.version }
