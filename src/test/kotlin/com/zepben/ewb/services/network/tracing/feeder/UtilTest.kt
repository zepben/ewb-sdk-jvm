...
class UtilTest {
    ...
    @Test
    fun `findLvFeeders works for sites and substations`() {
        //
        // tx0 21 b1(lvf5) 21--c2--2
        //     21 b3(lvf6) 21--c4--2
        ...
        val site = Site(generateId())
        val network = TestNetworkBuilder()
            .fromPowerTransformer { addToSite(site); addToSite(lvSub) } // tx0
            .toBreaker(isNormallyOpen = true, isOpen = true) { addToSite(site); addToSite(lvSub) }// b1
            .toAcls() // c2
            .branchFrom("tx0")
            .toBreaker(isNormallyOpen = false, isOpen = false) { addToSite(site); addToSite(lvSub) }//b3
            .toAcls() // c4
            .addLvFeeder("b1") // lvf5
            .addLvFeeder("b3") // lvf6
            .network
    ...
    private fun Equipment.addToSite(site: EquipmentContainer) {
