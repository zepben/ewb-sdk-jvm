...
class NetworkDatabaseTables : CimDatabaseTables() {
    ...
    override val includedTables: Sequence<SqliteTable> =
        super.includedTables + sequenceOf(
            ...
            com.zepben.evolve.database.sqlite.cim.tables.iec61970.base.wires.TablePerLengthSequenceImpedances(),
            ...
            com.zepben.evolve.database.sqlite.cim.tables.associations.TableProtectionRelayFunctionsSensors(),
