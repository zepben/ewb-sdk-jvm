...
import com.zepben.protobuf.cim.extensions.iec61970.infiec61970.infpart303.networkmodelprojects.NetworkModelProjectStageConflict as PBNetworkModelProjectStageConflict
...
/**  TODO: delete??
 * Convert the [NetworkModelProjectStageConflict] into its protobuf counterpart.
 *
 * @param cim The [NetworkModelProjectStageConflict] to convert.
 * @param pb The protobuf builder to populate.
 * @return [pb] for fluent use.
 */
fun toPb(cim: NetworkModelProjectStageConflict, pb: PBNetworkModelProjectStageConflict.Builder): PBNetworkModelProjectStageConflict.Builder =
    pb.apply {
        TODO()
    }
...
/**
 * An extension for converting any [NetworkModelProjectStageConflict] into its protobuf counterpart.
 */
fun NetworkModelProjectStageConflict.toPb(): PBNetworkModelProjectStageConflict = toPb(this, PBNetworkModelProjectStageConflict.newBuilder()).build() // FIXME: move.
...
class NetworkModelProjectCimToProto : BaseCimToProto() {
     ...
     * @return the protobuf form of [cim]
     */
    fun toPb(cim: NetworkModelProjectStageConflict): PBNetworkModelProjectStageConflict = cim.toPb()
