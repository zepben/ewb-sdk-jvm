...
class NetworkCimWriter(
    ...
    private fun writeContactDetails(
        table: TableContactDetails,
        insert: PreparedStatement,
        contactDetails: ContactDetails,
        description: String
    ): Boolean {
        insert.setNullableString(table.ID.queryIndex, contactDetails.id)
        ...
        status = status and writeContactDetailsStreetAddress(contactDetails, contactDetails.contactAddress)
    ...
    fun write(directionalCurrentRelay: DirectionalCurrentRelay): Boolean {
        ...
        return writeProtectionRelayFunction(table, insert, directionalCurrentRelay, "directionalCurrent relay")
    }
    ...
    @Throws(SQLException::class)
    private fun writeUsagePointContactDetails(
