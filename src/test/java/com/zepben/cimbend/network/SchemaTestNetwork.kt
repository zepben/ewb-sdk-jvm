...
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.baseVoltageOf
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createAcLineSegment
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createAccumulator
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createAnalog
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createDiagram
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createDiagramObject
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createDiscrete
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createEnergySource
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createFeeder
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createFeederStart
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createGeographicalRegion
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createJunction
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createOperationalRestriction
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createService
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createSite
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createSubGeographicalRegion
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createSubstation
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createSwitch
import com.zepben.cimbend.network.NetworkModelTestUtil.Companion.createTransformer
...
class SchemaTestNetwork {

    companion object {

        @JvmStatic
        fun createStupidlyLargeServices(): NetworkModelTestUtil.Services {
            ...
            networkService.connect(createTerminal(networkService, sourceNode, PhaseCode.ABCN, 1), createTerminal(networkService, acLineSegment101, PhaseCode.ABCN, 1))
            ...
            return NetworkModelTestUtil.Services(networkService, diagramService, customerService, measurementService)
        }
