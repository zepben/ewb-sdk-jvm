...
class TelephoneNumberTest {
    ...
    internal fun accessorCoverage() {
        ...
        assertThat(number.areaCode, equalTo("1"))
        assertThat(number.cityCode, equalTo("2"))
        assertThat(number.countryCode, equalTo("3"))
        assertThat(number.dialOut, equalTo("4"))
        assertThat(number.extension, equalTo("5"))
        assertThat(number.internationalPrefix, equalTo("6"))
        assertThat(number.localNumber, equalTo("7"))
        assertThat(number.isPrimary, equalTo(true))
        assertThat(number.description, equalTo("9"))
    }
