...
class DirectionalCurrentRelayTest {
    ...
    internal fun accessorCoverage() {
        ...
        assertThat(relay.polarizingQuantityType, equalTo(PolarizingQuantityType.QUADRATURE_VOLTAGE))
        assertThat(relay.relayElementPhase, equalTo(PhaseCode.XYN))
        assertThat(relay.minimumPickupCurrent, equalTo(4.4))
        assertThat(relay.currentLimit1, equalTo(5.5))
        assertThat(relay.inverseTimeFlag, equalTo(true))
        assertThat(relay.timeDelay1, equalTo(7.7))
    }
